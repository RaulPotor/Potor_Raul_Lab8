...
namespace Potor_Raul_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Potor_Raul_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Potor_Raul_Lab8Context context,
